...
public class PasswordGenerator {
    private static final String CHAR_LOWERCASE = "abcdefghijklmnopqrstuvwxyzåäö";
    ...
    private static final String PASSWORD_EXTRA =
    ...
    public static String generateStrongPassword() {
        ...
        String strOther = generateRandomString(PASSWORD_EXTRA, PASSWORD_LENGTH - 8);
